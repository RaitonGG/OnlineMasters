...
function bosa_default_styles(){
	...
	if( get_theme_mod( 'feature_posts_title_alignment', 'align-center' ) == 'align-center' ){
		$css .= '
		...
		';
	}elseif( get_theme_mod( 'feature_posts_title_alignment', 'align-center' ) == 'align-top' ) {
		$css .= '
			.feature-posts-layout-one .feature-posts-image {
		...
		';
	}elseif( get_theme_mod( 'feature_posts_title_alignment', 'align-center' ) == 'align-bottom' ) {
		$css .= '
			.feature-posts-layout-one .feature-posts-image {
	...
	if(  get_theme_mod( 'disable_feature_posts_title', false ) || get_theme_mod( 'disable_feature_title_divider', false ) ){
		$css .= '
			.feature-posts-layout-one .feature-posts-content-wrap .feature-posts-content:after {
    			display: none;
			}
		';
	}
