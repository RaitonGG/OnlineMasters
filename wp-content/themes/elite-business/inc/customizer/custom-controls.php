<?php
/**
 * Elite Business Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	 class Elite_Business_Image_Checkbox_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'elite_business_image_checkbox';
	 ...
	 */
	 class Elite_Business_Text_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'elite_business_text_radio_button';
	 ...
	 */
	class Elite_Business_Image_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'elite_business_image_radio_button';
	 ...
	 */
	class Elite_Business_Simple_Notice_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'elite_business_simple_notice';
	 ...
	 */
	class Elite_Business_Slider_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'elite_business_slider_control';
	 ...
	 */
	class Elite_Business_Toggle_Switch_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'elite_business_toggle_switch';
	 ...
	 */
	class Elite_Business_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'elite_business_sortable_repeater';
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			$this->button_labels = wp_parse_args( $this->button_labels,
				array(
					'add' => esc_html__( 'Add', 'elite-business' ),
				)
			);
		}
	 ...
	 */
	class Elite_Business_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'elite_business_dropdown_select2';
	 ...
	 */
	class Elite_Business_Dropdown_Posts_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'elite_business_dropdown_posts';
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			// Get our Posts
			$this->posts = Elite_Business_Customizer_Utilities::get_posts_as_array( $this->input_attrs );
		}
	 ...
	 */
	class Elite_Business_TinyMCE_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'elite_business_tinymce_editor';
		...
		public function to_json() {
			parent::to_json();
			$this->json['eliteBusinesstinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['eliteBusinesstinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
			$this->json['eliteBusinessmediabuttons'] = isset( $this->input_attrs['mediaButtons'] ) && ( $this->input_attrs['mediaButtons'] === true ) ? true : false;
		}
	 ...
	 */
	class Elite_Business_Note_Control extends WP_Customize_Control {
		public $type = 'elite_business_description';
	 ...
	 *
	 */
	class Elite_Business_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'elite-business-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="elite_business_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 */
	if ( ! function_exists( 'elite_business_url_sanitization' ) ) {
		function elite_business_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'elite_business_switch_sanitization' ) ) {
		function elite_business_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'elite_business_radio_sanitization' ) ) {
		function elite_business_radio_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'elite_business_text_sanitization' ) ) {
		function elite_business_text_sanitization( $input ) {
	 ...
	 */
	function elite_business_sanitize_select( $input, $setting ) {
