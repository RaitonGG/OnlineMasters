...
class Elite_Business_Portfolio_Options {
	...
	public function add_defaults( $default_options ) {
		$defaults = array(
			'elite_business_portfolio_visibility' => 'disabled',
			'elite_business_portfolio_number'     => 6,
		);
	...
	public function register_options( $wp_customize ) {
		Elite_Business_Customizer_Utilities::register_option(
			array(
				'settings'          => 'elite_business_portfolio_visibility',
				'type'              => 'select',
		...
		$wp_customize->selective_refresh->add_partial( 'elite_business_portfolio_visibility', array(
		...
		Elite_Business_Customizer_Utilities::register_option(
			array(
				...
				'settings'          => 'elite_business_portfolio_section_top_subtitle',
		...
		Elite_Business_Customizer_Utilities::register_option(
			array(
				'settings'          => 'elite_business_portfolio_section_title',
				'type'              => 'text',
				'sanitize_callback' => 'elite_business_text_sanitization',
		...
		Elite_Business_Customizer_Utilities::register_option(
			array(
				'settings'          => 'elite_business_portfolio_section_subtitle',
				'type'              => 'text',
				'sanitize_callback' => 'elite_business_text_sanitization',
		...
		Elite_Business_Customizer_Utilities::register_option(
			array(
				'settings'          => 'elite_business_portfolio_number',
				'type'              => 'number',
		...
		$numbers = elite_business_gtm( 'elite_business_portfolio_number' );
		...
		for( $i = 0, $j = 1; $i < $numbers; $i++, $j++ ) {
			Elite_Business_Customizer_Utilities::register_option(
				array(
					...
					'sanitize_callback' => 'absint',
					'settings'          => 'elite_business_portfolio_page_' . $i,
 ...
 * Initialize class
 */
$elite_business_ss_portfolio = new Elite_Business_Portfolio_Options();
